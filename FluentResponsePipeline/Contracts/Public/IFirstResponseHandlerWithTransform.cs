...
namespace FluentResponsePipeline.Contracts.Public
{
        ...
        : IBaseResponseHandler<TResult, TActionResult>
    {
        ...
        IFirstResponseHandlerWithTransform<TRequestResult, TTransformResult, TActionResult> ReplaceTransform<TTransformResult>(Func<IResponse<TRequestResult>, IResponse<TTransformResult>> transform);
    }
}