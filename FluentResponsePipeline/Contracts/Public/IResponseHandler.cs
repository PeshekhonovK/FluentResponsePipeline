...
{
    public interface IResponseHandler<out TParentResult, out TRequestResult, out TResult, TActionResult> : IBaseResponseHandler<TResult, TActionResult>
    {
        /// <summary>
        ...
        IResponseHandlerWithTransform<TParentResult, TRequestResult, TTransformResult, TActionResult> Transform<TTransformResult>(Func<IResponse<TParentResult>, IResponse<TRequestResult>, IResponse<TTransformResult>> transform);
    }
}